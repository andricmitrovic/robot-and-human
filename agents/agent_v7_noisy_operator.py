...
def train():
    env = gym.make('CollaborationEnv-v7', operator='noisy')  # Ensure it's registered properly
    ...
    torch.save(policy_net.state_dict(), "../output/saved_models/dqn_policy_model_v7_noisy.pth")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("../output/plots/dqn_reward_plot_noisy.png")
